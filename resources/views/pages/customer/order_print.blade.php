        ...
        <div id="invoiceContent">
            <div class="com_content d-flex py-2">
                ...
                <div class="com_address">
                    ...
                    <p class="m-0"><strong>Mobile:</strong> {{ $content->phone }}</p>
            ...
            <div class="custom-row">
                ...
                <div class="col-xs-5 text-right">
                    <strong class="b-text">Invoice No:</strong> <span class="normal-text">{{ $order->invoice_no}}</span><br>
                    <strong class="b-text">Order Date:</strong> <span class="normal-text">{{ $order->created_at->format('j F Y') }}</span>
                </div>
                <div class="cls"></div>
            </div>
            <div class="custom-row">
                ...
                <div class="col-xs-3 cus_total">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="text-right">${{ number_format($order->sub_total + $order->shipping_cost, 2) }}</td>
                        </tr>
                    </table>
                </div>
            </div>
...
@push('customer-js')
    <script>
        ...
        document.getElementById('words').innerHTML = inWords({{ $order->sub_total + $order->shipping_cost }});
